...
const BubbleBackground = () => {
  ...
  class Particle {
    constructor(x, y) {
      ...
      // Slower, more elegant base movement
      this.vx = (Math.random() - 0.5) * 0.5;
      this.vy = (Math.random() - 0.5) * 0.5;
      this.baseX = x;
      this.baseY = y;
      this.density = (Math.random() * 20) + 1;
      this.opacity = Math.random() * 0.4 + 0.1; // More subtle transparency
    }
    ...
    draw(ctx) {
      ...
      // Adding a subtle glow for that "premium tech" feel
      ctx.shadowBlur = 10;
